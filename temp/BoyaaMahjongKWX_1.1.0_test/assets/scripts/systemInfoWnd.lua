...
SystemInfoWnd.ctor = function()
	...
	SystemInfoWnd.m_root:setLevel(99);
	...
	SystemInfoWnd.m_info_bg:addChild(SystemInfoWnd.m_animNum);
	SystemInfoWnd.m_info_bg:addChild(SystemInfoWnd.m_memory);
	SystemInfoWnd.m_info_bg:addChild(SystemInfoWnd.m_fps);
...
SystemInfoWnd.setPos = function()
	SystemInfoWnd.m_root:setPos(-300,0);
	SystemInfoWnd.m_info_bg:setSize(320,45);
	SystemInfoWnd.m_info_bg:setPos(display.cx - 320 / 2, 0)
	SystemInfoWnd.m_animNum:setPos(5, 10);
	SystemInfoWnd.m_memory:setPos(100, 10);
	SystemInfoWnd.m_fps:setPos(250, 10);
