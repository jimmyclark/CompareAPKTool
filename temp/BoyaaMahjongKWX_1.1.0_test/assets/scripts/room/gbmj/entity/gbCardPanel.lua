...
local GbCardPanel = class(CardPanel)

function GbCardPanel:onAddCard(iCard, iHuaCards)
	GbCardPanel.super.onAddCard(self, iCard, iHuaCards)
...
function GbCardPanel:onGaiPaiOver(...)
	GbCardPanel.super.onGaiPaiOver(self, ...)
...
-- 广播开始游戏（国标花牌）
function GbCardPanel:onGameStartBd(data)
	GbCardPanel.super.onGameStartBd(data)
